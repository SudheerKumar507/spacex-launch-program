...
class App extends Component {
  ...
  render() {
    ...
    if (!isLoaded) {
      return <div className="spacex__loader-wrapper">
        <div className="spacex__loader">
      ...
      return (
        <div className="spacex">
          <h1 className="spacex__header">SpaceX Launch Programs</h1>
          <Container fluid>
            <Row>
              <Col xs={12} sm={12} md={6} lg={3}>
                <Card className="spacex-filter-card">
                  <Card.Body>
                    <Card.Title className="spacex-filter-card__header">
                      Filters
                    </Card.Title>
                    <Card.Text className="spacex-launch-year">
                      Launch Year
                      <hr className="spacex-hr" />
                    </Card.Text>

                    <Row>
                      <div className="spacex-button-container">
                    ...
                    <Card.Text className="spacex-filter-heading">
                      Successful Launch
                      <hr className="spacex-hr" />
                    </Card.Text>
            ...
            <div>
              <h5 className="spacex-author-name">
                Developed by : Sudheer Kumar Anyam 
              </h5>
            </div>
          </Container>
        </div>
